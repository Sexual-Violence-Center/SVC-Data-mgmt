...
import MedicalAdvocacyObject from '../ObjectLists/I-PMedicalAdvocacy.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
  return MedicalAdvocacyObject.filter(suggestion => {
    const keep =
...
class MedicalAdvocacyCustom extends React.Component {
  state = {
    inputValue: '',
  };
...
MedicalAdvocacyCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledMedicalAdvocacyCustom = withStyles(styles)(MedicalAdvocacyCustom);
export default connect(mapStateToProps)(styledMedicalAdvocacyCustom)
