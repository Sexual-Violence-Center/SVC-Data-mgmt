...
import PoliceReportObject from '../ObjectLists/PoliceReport.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
  return PoliceReportObject.filter(suggestion => {
    const keep =
...
class PoliceReportCustom extends React.Component {
  state = {
    inputValue: '',
  };
...
PoliceReportCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledPoliceReportCustom = withStyles(styles)(PoliceReportCustom);
export default connect(mapStateToProps)(styledPoliceReportCustom)
