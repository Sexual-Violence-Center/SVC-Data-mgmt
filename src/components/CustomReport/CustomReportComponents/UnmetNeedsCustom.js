...
import UnmetNeedsObject from '../ObjectLists/UnmetNeedsCustom.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
  return UnmetNeedsObject.filter(suggestion => {
    const keep =
...
class UnmetNeedsCustom extends React.Component {
  state = {
    inputValue: '',
    selectedItem: [],
  };
...
UnmetNeedsCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledUnmetNeedsCustom = withStyles(styles)(UnmetNeedsCustom);
export default connect(mapStateToProps)(styledUnmetNeedsCustom)
