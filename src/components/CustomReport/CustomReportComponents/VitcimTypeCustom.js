...
import VictimTypeObject from '../ObjectLists/VitcimTypeCustom.Object';
...
function getSuggestions(inputValue) {
  ...
  return VictimTypeObject.filter(suggestion => {
    const keep =
...
VictimTypeCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(VictimTypeCustom);
