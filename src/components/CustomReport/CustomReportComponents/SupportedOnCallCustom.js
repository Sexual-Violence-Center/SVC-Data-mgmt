...
import SupportedOnCallObject from '../ObjectLists/SupportedOnCallCustom.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
  return SupportedOnCallObject.filter(suggestion => {
    const keep =
...
class SupportedOnCallCustom extends React.Component {
  state = {
    inputValue: '',
  };
...
SupportedOnCallCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledSupportedOnCallCustom = withStyles(styles)(SupportedOnCallCustom);
export default connect(mapStateToProps)(styledSupportedOnCallCustom)
