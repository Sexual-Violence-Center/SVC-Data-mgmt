...
import PhoneServicesObject from '../ObjectLists/PhoneServices.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
  return PhoneServicesObject.filter(suggestion => {
    const keep =
...
class PhoneServicesCustom extends React.Component {
  state = {
    inputValue: '',
    selectedItem: [],
  };
...
PhoneServicesCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledPhoneServicesCustom = withStyles(styles)(PhoneServicesCustom);
export default connect(mapStateToProps)(styledPhoneServicesCustom)
