...
import LocationServiceObject from '../ObjectLists/Location.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
    return LocationServiceObject.filter(suggestion => {
    const keep =
...
LocationCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledLocationCustom = withStyles(styles)(LocationCustom);
export default connect(mapStateToProps)(styledLocationCustom)
