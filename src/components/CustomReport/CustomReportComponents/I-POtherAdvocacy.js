...
import OtherAdvocacyObject from '../ObjectLists/I-POtherAdvocacy.Object';
...
function getSuggestions(inputValue) {
  let count = 0;
  return OtherAdvocacyObject.filter(suggestion => {
    const keep =
...
class OtherAdvocacyCustom extends React.Component {
  state = {
    inputValue: '',
    selectedItem: [],
  };
...
OtherAdvocacyCustom.propTypes = {
  classes: PropTypes.object.isRequired,
};

const styledOtherAdvocacyCustom = withStyles(styles)(OtherAdvocacyCustom);
export default connect(mapStateToProps)(styledOtherAdvocacyCustom)
