...
const styledSpecialClassificationCustom = withStyles(styles)(SpecialClassificationCustom);
export default connect(mapStateToProps)(styledSpecialClassificationCustom)
