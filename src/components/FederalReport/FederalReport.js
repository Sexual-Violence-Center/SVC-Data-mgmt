        ...
        return <div style={{ flex: 1, margin: "auto", alignItems: "center", marginLeft: "300px" }}>
            ...
            <div className="dropdown">
              <section className="total">
                <h4>
                  Individuals who received services during the reporting
                  period
                </h4>
              ...
              <section className="new">
                <h4>
                  New individuals who received services during the
                  reporting period
                </h4>
                <table className="federalTable">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {this.props.state.getFederalReducer.new_victim}
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <table className="federalTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        {this.props.state.getFederalReducer.white}
                      </td>
                    </tr>
                    <tr>
                      <td>Other Race</td>
                      <td>
                        {this.props.state.getFederalReducer.Other}
                      </td>
                    </tr>
                    <tr>
              ...
              <section className="victimization">
                <h4>
                  Types of Victimization: total number during the
                  reporting period
                </h4>
                <table className="federalTable">
                  <thead>
              ...
              <section className="total">
                <h4>
                  Types of Victimization: Special classification of
                  individuals
                </h4>
                <table className="federalTable">
                  <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>LGBTQ</td>
                      <td>
                        {this.props.state.getFederalReducer.lgbtq}
                      </td>
                    </tr>
                    <tr>
                      <td>Veterans</td>
              ...
              <section className="assisted">
                <h4>
                  Individuals assisted with a victim compensation
              ...
              <section className="totalServices">
                <h4>
                  Total services provided during the reporting period
                </h4>
                <table className="federalTable">
                  <thead>
                    <tr>
              ...
              <section className="informationReferral">
                ...
                <table className="federalTable">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        (A1) Information about the criminal justice
                        proces
                      </td>
                      <td>
                        {
                    ...
                    <tr>
                      <td>
                        (A3) Referral to other victim support programs
                      </td>
                      <td>
                        {
                          this.props.state.getFederalReducer
                    ...
                    <tr>
                      <td>
                        (A4) Referral to other services, supports,
                        resources
                      </td>
                      <td>
                        {
              ...
              <section className="">
                ...
                <table className="federalTable">
                  ...
                  <tbody>
                    <tr>
                      <td>
                        (B1) Victim Advocacy/Accompaniment to Emergency
                        Medical Care
                      </td>
                      <td>
                        {
                    ...
                    <tr>
                      <td>
                        (B2) Victim Advocacy/Accompaniment to Medical
                        Forensic Exam
                      </td>
                      <td>
                        {
                    ...
                    <tr>
                      <td>
                        (B7) Intervention with Employer, Creditor,
              ...
              <section className="emotionalSupport">
                <h4>
                  (C) Emotional Support of Safety Services: Total
              ...
              <section className="total">
                <h4>
                  (E) Criminal/Civil Justice System Assistance: Total
                  services provided during the reporting period
                </h4>
                <table className="federalTable">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      <td>
                        (E4) Civil Legal Assistance in Obtaining
                        Protection or Restraining Order
                      </td>
                      <td>
                        {this.props.state.getFederalReducer.ofp_hro}
                      </td>
                    </tr>
                    <tr>
                      <td>
