...
class CountyReport extends Component{ 
    ...
    render () {
        return <div className="federalReport">
            <AdminNav />
            <div style={{ flex: 1, margin: "auto", alignItems: "center", marginLeft: "300px" }}>
              ...
              <div className="dropdown">
                <section className="total">
                  <h4>
                    Hennepin County residents who received services
                ...
                <section className="new">
                  <h4>
                    New Hennepin County residents who recieved services
                    during the reporting period
                  </h4>
                  <table className="countyTable">
                    <thead>
                    ...
                    <tbody>
                      <tr>
                        <td>
                          Total Clients Served During the Reporting
                          Period
                        </td>
                        <td>
                          {this.props.state.getCountyReducer.new_victim}
                        </td>
                      </tr>
                      <tr>
                        <td>
                          Total Clients Served in Advocacy Program
                        </td>
                        <td>
                          {this.props.state.getCountyReducer.new_victim}
                        </td>
                      ...
                      <tr>
                        <td>
                          Total Clients Served in Individual Counseling
                          Program
                        </td>
                        <td>
                          {
                            this.props.state.getCountyReducer
                              .total_clients_individual_counseling
                          }
                        </td>
                      </tr>
                      <tr>
                        <td>
                          Total Clients Served in Group Counseling
                          Program
                        </td>
                        <td>
                          {
                            this.props.state.getCountyReducer
                              .total_clients_group_counseling
                          }
                        </td>
                      </tr>
                      <tr>
                ...
                <section className="county">
                  <h4>
                    New Hennepin County residents by victim type who
                    recieved services during the reporting period
                  </h4>
                  <table className="countyTable">
                    <thead>
                      <tr>
                  ...
                  <table className="countyTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          {this.props.state.getCountyReducer.white}
                        </td>
                      </tr>
                      <tr>
                        <td>Other Race</td>
                        <td>
                          {this.props.state.getCountyReducer.other}
                        </td>
                      </tr>
                      <tr>
