...
const fedQueryText = `SELECT (select count(*) FROM "victim" WHERE "contact_date" BETWEEN $1 AND $2) as "total_victims",
...
OR ("victim_prior_contact" = TRUE AND "victim_contact_prior_oct" = TRUE)) AND "contact_date" BETWEEN $1 AND $2)) 
as "anon_victim", (select COUNT(*) FROM "victim" WHERE "victim_ethnicity" = 'Asian' 
...
(select COUNT(*) FROM "victim" WHERE ("victim_ethnicity" = 'unknown' OR "victim_ethnicity" IS NULL) AND ("victim_prior_contact" = 
...
(select count(*) FROM "victim" WHERE "victim_age" BETWEEN 18 AND 24 AND "contact_date" BETWEEN $1 AND $2) as 
"victim_age_eighteen_to_twentyfour", 
(select count(*) FROM "victim" WHERE "victim_age" BETWEEN 25 AND 59 AND "contact_date" BETWEEN $1 AND $2) as 
"victim_age_twentyfive_to_fiftynine", 
(select count(*) FROM "victim" WHERE "victim_age" >= 60 AND "contact_date" BETWEEN $1 AND $2) as 
"victim_age_sixty_and_older", 
(select count(*) FROM "victim" WHERE "victim_age" IS NULL AND ("victim_prior_contact" = FALSE OR "victim_prior_contact" IS NULL OR 
("victim_prior_contact" = TRUE AND "victim_contact_prior_oct" = TRUE)) AND "contact_date" BETWEEN $1 AND $2) as 
"victim_age_unknown", 
(select COUNT("victim_age") FROM "victim" WHERE "contact_date" BETWEEN $1 AND $2) as "total_age_count", 
(select COUNT(*) FROM "victim" WHERE "violence_adult_sexual" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_adult_sexual", 
(select COUNT(*) FROM "victim" WHERE "violence_adult_when_child_by_family" = TRUE AND "contact_date" BETWEEN $1 AND 
$2) as "violence_adult_when_child_by_family", 
(select COUNT(*) FROM "victim" WHERE "violence_adult_when_child_by_other" = TRUE AND "contact_date" BETWEEN $1 AND 
$2) as "violence_adult_when_child_by_other", 
(select COUNT(*) FROM "victim" WHERE ("violence_adult_when_child_by_other" = TRUE OR "violence_adult_when_child_by_family" = TRUE) 
AND "contact_date" BETWEEN $1 AND $2) as "violence_adult_when_child_total", 
(select COUNT(*) FROM "victim" WHERE "violence_bullying" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_bullying", 
(select COUNT(*) FROM "victim" WHERE "violence_bullying" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_bullying", 
(select COUNT(*) FROM "victim" WHERE "violence_child_pornography" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_child_pornography", 
(select COUNT(*) FROM "victim" WHERE "violence_minor_by_family" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_minor_by_family", 
(select COUNT(*) FROM "victim" WHERE "violence_minor_by_other" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_minor_by_other", 
(select COUNT(*) FROM "victim" WHERE ("violence_minor_by_other" = TRUE OR "violence_minor_by_family" = TRUE) AND "contact_date" 
BETWEEN $1 AND $2) as "violence_minor_total", 
(select COUNT(*) FROM "victim" WHERE "violence_domestic" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_domestic", 
(select COUNT(*) FROM "victim" WHERE "violence_elder" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_elder", 
(select COUNT(*) FROM "victim" WHERE "violence_exploitation_trafficking" = TRUE AND "contact_date" BETWEEN $1 AND 
$2) as "violence_exploitation_trafficking", 
(select COUNT(*) FROM "victim" WHERE "violence_exposing" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_exposing", 
(select COUNT(*) FROM "victim" WHERE "violence_internet" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_internet", 
(select COUNT(*) FROM "victim" WHERE "violence_phone" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_phone", 
(select COUNT(*) FROM "victim" WHERE "violence_harassment" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_harassment", 
(select COUNT(*) FROM "victim" WHERE "violence_stalking" = TRUE AND "contact_date" BETWEEN $1 AND $2) as 
"violence_stalking", 
...
"legal_prosecution_related" = TRUE) AND "contact_date" BETWEEN $1 AND $2) as "info_criminal_justice_process", 
...
"medical_accompaniment_dental" = TRUE) AND "contact_date" BETWEEN $1 AND $2) as "emergency_med_care", 
...
"transportation_medical_accompaniment_medical" = TRUE OR "transportation_medical_accompaniment_dental" =TRUE) AND 
...
(SELECT  COUNT(*) as "total_A_information_referral" FROM "victim" WHERE ("legal_court_advocacy" = TRUE OR 
"information_criminal_justice" = TRUE OR "legal_law_enforcement_interview" = TRUE OR "legal_prosecution_related" = TRUE OR 
"referral_agency" IS NOT NULL OR "referral_other" IS NOT NULL) AND "contact_date" BETWEEN $1 AND $2),
(SELECT  COUNT(*) as "total_B_personal_advocacy_accompaniment" FROM "victim" WHERE (("medical_accompaniment_medical" = TRUE OR 
"medical_accompaniment_dental" = TRUE) OR "medical_exam_support" = TRUE OR "legal_law_enforcement_interview" = TRUE OR 
"legal_immigration" = TRUE OR "legal_intervention" = TRUE OR ("transportation_medical_exam_support" = TRUE OR 
"transportation_medical_accompaniment_medical" = TRUE OR "transportation_medical_accompaniment_dental" =TRUE)) 
...
("contact_type" = 'phone' OR "contact_type" = 'in-person' OR "crisis_counseling_individual" = TRUE OR "crisis_counseling_group" = 
TRUE OR "emergency_financial" = TRUE ) 
AND ("victim_prior_contact" = FALSE OR "victim_prior_contact" IS NULL OR ("victim_prior_contact" = TRUE AND 
"victim_contact_prior_oct" = TRUE )) AND "contact_date" BETWEEN $1 AND $2), 
(SELECT COUNT(*) as "total_E_criminal_civil_justice_system" FROM "victim" WHERE ("legal_oft_hro" = TRUE OR 
"other_emergency_justice" = TRUE OR "legal_immigration" = TRUE OR "legal_prosecution_related" = TRUE OR 
